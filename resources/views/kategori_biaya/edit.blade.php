...
<main>
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <form method="POST" enctype="multipart/form-data" action="{{ route('kategori-biaya.update',$data->id) }}">
                @csrf
                @method('PATCH')
                <div class="card-body pb-5">
                    <div>
                        <label>Nama Kategori Biaya</label>
                        <input name="txt_nama_kategori_biaya" type="" placeholder="" value="{{ old('txt_nama_kategori_biaya', $data->nama) }}" 
